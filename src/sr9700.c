...
{
	/* FIX: backported from https://github.com/torvalds/linux/commit/fa0b198be1c6775bc7804731a43be5d899d19e7a */
...
static int sr9700_bind(struct usbnet *dev, struct usb_interface *intf)
{
	 ...
	 */
	/* FIX: read into local buf `addr` instead of directly to netdev */
	...
	/* FIX: copy addr to netdev->dev_addr */
	memcpy(netdev->dev_addr, addr, ETH_ALEN);
	netdev_info(netdev, "MAC read from registers: %pM\n", netdev->dev_addr);
...
static const struct usb_device_id products[] = {
	...
	/* FIX: add 0x9702 interface 1, aka SR9700B/SR9702. interface 0 is a sketchy virtual CDROM */
	{
